...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options=[{'label': 'All Sites', 'value': 'ALL'},\
                                    {'label': 'KSC LC-39A', 'value': 'KSC LC-39A'}, {'label': 'CCAFS LC-40', 'value': 'CCAFS LC-40'},\
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values='count', names='class', title=f'Total Success Launches by {entered_site}')
        return fig
...
def get_scatter_graph(entered_site, payload_slider):
    ...
    if entered_site == 'ALL':
        ...
        fig.update_layout(title_text='Correlation between Payload and Success for all sites')
        return fig
    
    else:
        filtered_df = filtered_df[filtered_df['Launch Site'] == entered_site]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version')
        fig.update_layout(title_text=f'Correlation between Payload and Success for {entered_site}')
        return fig
